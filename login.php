        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
                ...
                <span class="navbar-text">
                    <a id="login" data-toggle="modal" data-target="#loginModal">         <!-- triggering login modal data-toggle="modal" data-target="#loginModal"-->
                        <button class="btn btn-warning"><span class="fa fa-sign-in"></span><b> Fill login details here!</b></button>
                    </a>
                </span>

                <span class="navbar-text">      <!-- triggering login modal data-toggle="modal" data-target="#loginModal"-->
                    &nbsp;&nbsp;<a href="./signup.php"><span class="fa fa-sign-in"></span> SignUp</a>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Login</h4>
                        <button id="cancelB1" type="button" class="close">
                            &times;   <!-- &times; means a multiplication sign (here used a cross sign to dismiss modal)-->
                        </button>
                </div>

                <div class="modal-body">
                <center><form action="/root/login.php" method="post">
                        <div class="form-col">
                            <div class="form-group col-sm-4">
                                    <label class="sr-only" for="username">Username</label>
                                    <input type="text" class="form-control form-control-sm mr-1" id="username" name="username" placeholder="Username" required>
                            </div>
                            <div class="form-group col-sm-4">
